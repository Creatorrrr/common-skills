...
<!-- Create only after all final criteria of the adjudicated milestone pass and one of the three listed qualifications holds. No passed report for partial or blocked goals. Routine test passes do not qualify. -->
...
# [Reusable success case title]

- Recorded: YYYY-MM-DD HH:MM TZ
- Status: active | superseded
- Qualification: resolved-material-failure | non-obvious-after-default-failed | required-reproduction-procedure
- Goal/problem signature:
- Search terms:
- Affected scope:
- Excluded scope:
...
- Prefer:
- Minimum verification when reused:
- Applicable when:
- Do not apply when:
